...
## Before you trust any number: [`INSTALL_INTEL.md`](INSTALL_INTEL.md)

That document records the stack this suite needs on Intel Core Ultra (CPU / Arc iGPU / NPU), how to build it,
